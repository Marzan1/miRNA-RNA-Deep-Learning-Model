...
new_sequences = [
    "AAUACCCGCCAGAUUGGUCGUUGGG",  # Example sequence 1
    "GAUACCCGCUCCCCAGUUAUAGGGG",  # Example sequence 2
    "GAUACCCGGAGGAGACUGGAGUUGG",  # Example sequence 3
...
top_n = 50  # Number of top miRNAs to select
