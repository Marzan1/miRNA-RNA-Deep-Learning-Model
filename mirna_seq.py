...
RRE_SEQUENCE = "GGGUGUGGAAAUCUCUGGGUUAGACCAGAUCUGAGCUGGGUUCUCUGGGCAGCCAGAGGUGGUCUUAGCCUUCUUGAAUCCUGGCCUCCUCCAGGAUCCCAGGGUUCAAAUCCCACUGGCCUUGGCUGAAGGGGCAGUAGUCCUUCUGAUUGGCCAGGCUGCCUUCUGCUCCUGCUGGCCAGGCAGGUGCUGGCCACUAGCUGGUGACUAGUGACUUGCUGAUAGGGUGGGCUAUUUUCCUACU"
STEM_IIB_SITE = "AGGUGGU"  # Example of Stem IIB binding region (can be adjusted)
...
synthetic_mirnas = generate_mirnas(10, SEQUENCE_LENGTH_MIN, SEQUENCE_LENGTH_MAX, GC_CONTENT_MIN, GC_CONTENT_MAX)
